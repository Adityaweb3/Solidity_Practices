// creating a Funding  DAO, where people can use MATIC tokens to become either a Member or Stakeholder in the DAO. Members can apply for fundingfor their project 
//and Stakeholders can vote on the projects to fund from the DAO treasury.
